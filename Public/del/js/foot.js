...
function clearcookie() {
	document.cookie = "qy_username=; path=/;domain=127.0.0.4;expires=" + new Date(1970, 1, 1).toGMTString(), document.cookie = "qy_userpwd=; path=/;domain=127.0.0.4;expires=" + new Date(1970, 1, 1).toGMTString(), document.cookie = "qy_userid=; path=/;domain=127.0.0.4;expires=" + new Date(1970, 1, 1).toGMTString()
}
function userreg() {
