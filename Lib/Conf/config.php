...
$array = array(
	'USER_AUTH_KEY'=>'gxl',// 用户认证SESSION标记
	'NOT_AUTH_ACTION'=>'index,top,left,main',// 默认无需认证操作
	'REQUIRE_AUTH_MODULE'=>'Admin,List,News,Area,Data,Upload,Link,Ads,Cache,Create,Tpl,Tag,Special,Pic,Slide,Member,Nav,Zhidao',// 默认需要认证模型
    'URL_PATHINFO_DEPR'=>'-',
	'DEFAULT_C_LAYER'=>  'Action', // 默认的控制器层名称
	'MODULE_ALLOW_LIST'=>array('Admin','Home','Plus','User','Pay'),//项目分组
