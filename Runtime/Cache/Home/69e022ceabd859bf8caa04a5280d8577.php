...
<body>
<table border="0" align="center" cellpadding="5" cellspacing="1" style="color:#333333;margin-top:100px;background:#152028">
...
<tr><td style="background:#FFF; padding:20px 10px; font-size:12px; line-height:25px">
	<font style="color:#152028;font-size:14px"><?php if(isset($message)) {?>
<?php echo($message); ?>
<?php }else{?>
<?php echo($error); ?>
